      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[620px] mx-auto">
            Lorem ipsum dolor sit amet consectetur adipiscing elit placerat id mus dapibus nulla, morbi hendrerit mollis dui cursus blandit iaculis 
            sollicitudin sapien sagittis. Primis nulla bibendum quisque interdum cum vulputate
          </p>
        </div>
